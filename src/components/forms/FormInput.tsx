    ...
    <div className="space-y-1.5 w-full">
      ...
      <div className="relative">
        ...
        <input
          id={name}
          {...register(name)}
          className={`w-full py-2.5 px-4 rounded-xl border text-xs font-semibold bg-zinc-50/50 dark:bg-zinc-950 text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-primary-glow transition duration-150 ${
            icon ? "pl-10" : ""
          } ${
            errorMessage
